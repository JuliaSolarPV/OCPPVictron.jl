...
DocMeta.setdocmeta!(OCPPVictron, :DocTestSetup, :(using OCPPVictron); recursive = true)
...
makedocs(;
    ...
    repo = "https://github.com/JuliaSolarPV/OCPPVictron.jl/blob/{commit}{path}#{line}",
    sitename = "OCPPVictron.jl",
    format = Documenter.HTML(; canonical = "https://JuliaSolarPV.github.io/OCPPVictron.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/JuliaSolarPV/OCPPVictron.jl")
